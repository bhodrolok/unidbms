...
CREATE TABLE `ta` (
  ...
  PRIMARY KEY (`G_id`,`Course_id`),
  UNIQUE KEY `G_id_UNIQUE` (`G_id`),
  UNIQUE KEY `Course_id_UNIQUE` (`Course_id`),
  CONSTRAINT `Course_id_ta` FOREIGN KEY (`Course_id`) REFERENCES `course` (`Course_id`),
  CONSTRAINT `G_id_ta` FOREIGN KEY (`G_id`) REFERENCES `graduate` (`G_id`)
