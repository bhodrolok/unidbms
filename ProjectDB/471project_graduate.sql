...
CREATE TABLE `graduate` (
  ...
  PRIMARY KEY (`Student_id`,`G_id`,`Department_id`),
  UNIQUE KEY `Student_id_UNIQUE` (`Student_id`),
  UNIQUE KEY `G_id_UNIQUE` (`G_id`),
  UNIQUE KEY `Department_id_UNIQUE` (`Department_id`),
  CONSTRAINT `Department_id_grad` FOREIGN KEY (`Department_id`) REFERENCES `department` (`Department_id`),
  CONSTRAINT `Student_id_grad` FOREIGN KEY (`Student_id`) REFERENCES `student` (`Student_id`)
