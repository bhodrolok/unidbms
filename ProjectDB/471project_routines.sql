...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_student`(IN StudentUsername VARCHAR(45), 
IN Password VARCHAR(45), IN StudentName VARCHAR(45), IN StudentID INT, 
IN YearEnrolled INT, IN GPA FLOAT, IN AdminID INT, IN AppStatus VARCHAR(45),
IN AdminUsername VARCHAR(45), IN AdminName VARCHAR(45))
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `search_student`(IN studentID INT)
BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_app`(IN studentID VARCHAR(45), 
IN appStatus VARCHAR(45))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `view_student_app` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `view_student_app`(IN StudentID INT)
BEGIN
...
-- Dump completed on 2020-12-08 18:27:29
