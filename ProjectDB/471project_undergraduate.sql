...
CREATE TABLE `undergraduate` (
  ...
  CONSTRAINT `Department_id_ugrad` FOREIGN KEY (`Department_id`) REFERENCES `department` (`Department_id`),
  CONSTRAINT `Student_id_ugrad` FOREIGN KEY (`Student_id`) REFERENCES `student` (`Student_id`)
