...
CREATE TABLE `prof` (
  ...
  PRIMARY KEY (`Prof_id`,`Username`,`Program_id`),
  UNIQUE KEY `Prof_id_UNIQUE` (`Prof_id`),
  UNIQUE KEY `Username_UNIQUE` (`Username`),
  UNIQUE KEY `Program_id_UNIQUE` (`Program_id`),
  CONSTRAINT `Program_id_prof` FOREIGN KEY (`Program_id`) REFERENCES `program` (`Program_id`),
  CONSTRAINT `Username_prof` FOREIGN KEY (`Username`) REFERENCES `user` (`Username`)
